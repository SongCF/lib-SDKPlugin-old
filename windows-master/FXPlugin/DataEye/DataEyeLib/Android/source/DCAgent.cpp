...
void DCVirtualCurrency::paymentSuccess(const char* orderId, const double currencyAmount, const char* currencyType, const char* paymentType)
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID) 
	DCJniMethodInfo methodInfo;
...
void DCVirtualCurrency::paymentSuccessInLevel(const char* orderId, const double currencyAmount, const char* currencyType, const char* paymentType, const char* levelId)
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID) 
    DCJniMethodInfo methodInfo;
